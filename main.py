...
if __name__ == "__main__":
    ...
    # Check for --webui early before importing tkinter
    ...
    if use_webui:
        # Web UI mode: use standard argparse without tkinter
        ...
        parser.add_argument("--webui", action="store_true", help="Use web-based UI instead of Tkinter")
        parser.add_argument(
        ...
        # Standard GUI mode: use tkinter for error messages
    ...
    async def main():
        ...
        exit_status = 0
        # Select GUI class based on --webui flag
        gui_class = None
        if use_webui:
            from webui import WebUIManager
            gui_class = WebUIManager
        client = Twitch(settings, gui_class=gui_class)
